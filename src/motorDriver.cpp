...
void mclass::set_speed(Motors motor_ch, Direction dir, int new_speed) {
  ...
  void mclass::forward(int speed){
    set_speed(MotorA,Forward,speed);
    set_speed(MotorB,Forward,speed);
}

 void mclass::backward(int speed){
    set_speed(MotorA,Backward,speed);
    set_speed(MotorB,Backward,speed);
}

 void mclass::clockwise(int speed){
    set_speed(MotorA,Forward,speed);
    set_speed(MotorB,Forward,0);
}

 void mclass::anticlockwise(int speed){
    set_speed(MotorA,Forward,0);
    set_speed(MotorB,Forward,speed);
}
